...
<script>
        ...
        $(document).ready(function () {
            ...
            $('#save').click(function (event) {
                ...
                if (!$("input:checked[id='check_1']").is(":checked")){
                	alert("개인정보 처리방침 동의를 해주세요"); 
                	$("#check_1").focus(); 
                	return false; 
                }
                if (!$("input:checked[id='check_2']").is(":checked")){
                	alert("서비스 이용약관 동의를 해주세요"); 
                	$("#check_1").focus(); 
                	return false; 
                }
...
제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “어따세워”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
